...
<form method="post"
 ...
 <input type="text" class="form-control" name="nama_pizza"value="{{ old('nama_pizza', $pizza->nama_pizza) }}"/>
 <label for="harga_satuan" class="col-form-label">Harga Satuan</label>
 <input type="text" class="form-control" name="harga_satuan"value="{{ old('harga_satuan', $pizza->harga_satuan) }}"/>
 <br/>
